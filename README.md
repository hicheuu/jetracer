...
### 실시간 조향 보정 게인 조정 (Steer Gain Tuning)
주행 중 좌/우 조향 시의 전압 강하 보정치를 실시간으로 0.001 단위로 튜닝할 수 있습니다.
- **R2 버튼 (Right Trigger)**: 현재 조향 방향의 게인 **증가** (+0.001)
- **L2 버튼 (Left Trigger)**: 현재 조향 방향의 게인 **감소** (-0.001)
- *사용법: 핸들을 왼쪽으로 꺾은 상태에서 L2/R2를 누르면 좌측 게인이, 오른쪽으로 꺾은 상태면 우측 게인이 조절됩니다.*
